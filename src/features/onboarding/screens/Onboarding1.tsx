    ...
    <SafeAreaView style={styles.safe}>
      <View style={styles.container}>
        ...
        <View style={styles.logoRow}>
          {/* If you have logo icon PNG, replace below View with <Image /> */}
        ...
        {/* Title + Subtitle */}
        <Text style={styles.title}>Welcome to Dvaari</Text>
        <Text style={styles.subtitle}>
          Your smart doorbell companion that makes every delivery safe, simple,
          and secure.
        </Text>
